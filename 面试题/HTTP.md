...
![三个部分](HTTP.assets/640.webp)三个部分
...
![三方协议和租房协议](HTTP.assets/640.png)三方协议和租房协议
...
![五大类 HTTP 状态码](HTTP.assets/640.webp)五大类 HTTP 状态码
...
![GET 请求](HTTP.assets/640.webp)GET 请求

而`POST` 方法则是相反操作，它向 `URI` 指定的资源提交数据，数据就放在报文的 body 里。

比如，你在我文章底部，敲入了留言后点击「提交」（**暗示你们留言**），浏览器就会执行一次 POST 请求，把你的留言文字放进了报文 body 里，然后拼接好 POST 请求头，通过 TCP 协议发送给服务器。

![POST 请求](HTTP.assets/640.webp)POST 请求
...
![Cookie 技术](HTTP.assets/640-1585493012832.webp)Cookie 技术
...
![img](HTTP.assets/640-1585493012626.webp)
...
![短连接与长连接](HTTP.assets/640-1585493012599.webp)短连接与长连接
...
![管道网络传输](HTTP.assets/640-1585493012600.webp)管道网络传输
...
![队头阻塞](HTTP.assets/640-1585493012603.webp)队头阻塞
...
![HTTP 与 HTTPS 网络层](HTTP.assets/640-1585493012625.webp)
...
![混合加密](HTTP.assets/640-1585493012626.webp)混合加密
...
![校验完整性](HTTP.assets/640-1585493012636.webp)校验完整性
...
![数子证书工作流程](HTTP.assets/640-1585493012659.webp)数字证书工作流程
...
![HTTPS 连接建立过程](HTTP.assets/640-1585493012679.webp)HTTPS 连接建立过程
...
![报文区别](HTTP.assets/640-1585493012665.webp)报文区别
...
![HTT/1 ~ HTTP/2](HTTP.assets/640-1585493012698.webp)HTT/1 ~ HTTP/2
...
![多路复用](HTTP.assets/640-1585493012703.webp)多路复用
...
![HTTP/1 ~ HTTP/3](HTTP.assets/640-1585493012728.webp)HTTP/1 ~ HTTP/3
...
![TCP HTTPS（TLS/1.3） 和 QUIC HTTPS](HTTP.assets/640-1585493012736.webp)TCP HTTPS（TLS/1.3） 和 QUIC HTTPS
